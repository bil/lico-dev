...
#define NUM_SEM_SIGS 3

// Number of internal signals
#define NUM_INTERNAL_SIGS 3
...
#define ASYNC_MUTEXES_SIZE (sizeof(pthread_mutex_t) * NUM_ASYNC_READERS)
...
#define ASYNC_MUTEXES_OFFSET (BUF_VARS_OFFSET + BUF_VARS_SIZE)

// Results in a simple total size calculation
#define SHM_SIZE (NUM_TICKS_SIZE + BUF_VARS_SIZE + ASYNC_MUTEXES_SIZE)
