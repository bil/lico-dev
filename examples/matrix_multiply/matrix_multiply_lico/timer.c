...
static char moduleProcnames[NUM_MODULES][MAX_MODULE_NAME_LEN] = {"matmul_init", "matmul", "matmul_print"};
static char nonSourceProcnames[NUM_NON_SOURCES][MAX_MODULE_NAME_LEN] = {"matmul_init", "matmul", "matmul_print"};
static int moduleTopoLens[TOPO_HEIGHT] = {1, 1, 1};
static int moduleTopoOrder[TOPO_HEIGHT][1];
static int nonSourceModuleCheck[NUM_NON_SOURCES] = {1, 1, 1};
...
int main(int argc, char* argv[]) {
  ...
  *pNumTicks = -1 * INIT_BUFFER_TICKS;
  ...
  moduleTopoOrder[1][0] = 1;
  moduleTopoOrder[2][0] = 2;
