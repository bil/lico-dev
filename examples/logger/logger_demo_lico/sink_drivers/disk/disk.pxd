...
ctypedef struct signalsTickData:
    int16_t vector_ints[3]
    int8_t scalar_out[1]
    double vector_floats[4]
    double matrix_out[4]
...
cdef class DiskSinkDriver(sink_driver.SinkDriver):
    ...
    cdef SQLTableElement signalsTableArr[4 + 5]
    ...
    # message pack
    cdef msgpack_sbuffer mpSignalsMatrix_outBuf
    cdef msgpack_packer mpSignalsMatrix_outPk
