...
wget https://www.kernel.org/pub/linux/kernel/v5.x/linux-5.4.221.tar.gz
wget https://www.kernel.org/pub/linux/kernel/projects/rt/5.4/patch-5.4.221-rt79.patch.gz
...
mkdir -p $KERNEL_DIR
cd $KERNEL_DIR
tar -zxvf $TMP_DIR/linux-5.4.221.tar.gz
cd linux-5.4.221
...
# install kernel
sudo dpkg --force-confdef --force-confnew -i $KERNEL_DIR/linux-image-5.4.221-licorice-rt79_5.4.221-licorice-rt79-10.00.Custom_amd64.deb
sudo dpkg --force-confdef --force-confnew -i $KERNEL_DIR/linux-headers-5.4.221-licorice-rt79_5.4.221-licorice-rt79-10.00.Custom_amd64.deb
